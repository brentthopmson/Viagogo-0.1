        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg max-w-lg w-full p-6">
          ...
          <div className="space-y-3">
            <button
              ...
              className="w-full p-4 bg-gradient-to-r from-green-50 to-green-100 border-2 border-green-200 rounded-xl text-left hover:border-[#89CF28] transition-all group"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            ...
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                className="w-full p-3 bg-gray-50 border-2 border-transparent rounded-xl focus:border-[#89CF28] focus:bg-white outline-none transition-all font-bold text-[#89CF28]"
              />
            </div>
          ...
          <div className="mb-4">
            <div className="flex justify-between items-center mb-1 ml-1">
              ...
              <button 
                ...
                className="text-[10px] font-bold text-[#89CF28] hover:underline"
              >
                + Add Another Image
              </button>
            </div>
